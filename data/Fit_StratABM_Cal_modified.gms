...
* ---Define Parameters for part (5):
  Parameter
     ...
     p_cropPrice    "Price of silage maize Euro/st" /4.8/
...
*
p_attyield(gn) =  p_yieldMdm(gn,'t2009')/p_drymatter * 10 * (1 + p_affYieldShare);
...
/ [100 * ( exp(p_CRate * p_TDistribution(gn,'t2009',s_process) )
