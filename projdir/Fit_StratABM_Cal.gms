...
p_cropPrice    "Price of silage maize Euro/st" /4.2/
...
*
p_attyield(gn) =  p_yieldMdm(gn,'t1999')/p_drymatter * 10 * (1 + p_affYieldShare);
...
/ [100 * ( exp(p_CRate * p_TDistribution(gn,'t1999',s_process) )
