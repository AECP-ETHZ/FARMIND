...
p_cropPrice    "Price of silage maize Euro/st" /4.5/
...
*
p_attyield(gn) =  p_yieldMdm(gn,'t2001')/p_drymatter * 10 * (1 + p_affYieldShare);
...
/ [100 * ( exp(p_CRate * p_TDistribution(gn,'t2001',s_process) )
