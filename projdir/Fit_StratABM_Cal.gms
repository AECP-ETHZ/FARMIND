...
p_cropPrice    "Price of silage maize Euro/st" /5.0/
...
*
p_attyield(gn) =  p_yieldMdm(gn,'t2000')/p_drymatter * 10 * (1 + p_affYieldShare);
...
/ [100 * ( exp(p_CRate * p_TDistribution(gn,'t2000',s_process) )
