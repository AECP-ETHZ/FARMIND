...
public class Consumat {
	...
	public static void main(String[] args) {
		...
		initializeRegionIncomeChangePercent(allFarms);						   // initialize the farms with the input values before starting the full ABM simulation
	...
	private static void CreateGamsFile(List<Farm> allFarms, int year, List<Double> simulatedIncomeForFarms) {
		...
		for (Farm farm : allFarms) {
			...
			farm.updateFarmData(allFarms, income);
